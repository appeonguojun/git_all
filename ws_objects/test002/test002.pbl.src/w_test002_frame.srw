$PBExportHeader$w_test002_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_test002_frame from window
end type
type mdi_1 from mdiclient within w_test002_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_test002_frame"
...
global w_test002_frame w_test002_frame

type variables
n_test002_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_test002_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_test002_sheet1", "w_test002_sheet2", "w_test002_sheet3" }
...
inv_sheetmgt = Create n_test002_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_test002_frame.create
if this.MenuName = "m_test002_frame" then this.MenuID = create m_test002_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_test002_frame.destroy
