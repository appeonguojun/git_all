$PBExportHeader$w_test003_toolbars.srw
$PBExportComments$Generated MDI Toolbar Configuration
forward
global type w_test003_toolbars from window
end type
type rb_floating from radiobutton within w_test003_toolbars
end type
type rb_bottom from radiobutton within w_test003_toolbars
end type
type rb_right from radiobutton within w_test003_toolbars
end type
type rb_top from radiobutton within w_test003_toolbars
end type
type rb_left from radiobutton within w_test003_toolbars
end type
type cb_done from commandbutton within w_test003_toolbars
end type
type cb_visible from commandbutton within w_test003_toolbars
end type
type cbx_showtips from checkbox within w_test003_toolbars
end type
type cbx_showtext from checkbox within w_test003_toolbars
end type
type gb_options from groupbox within w_test003_toolbars
end type
end forward
...
global w_test003_toolbars w_test003_toolbars
